        ...
        .map(({ node }, i) => (
          <div className="project" key={i}>
            <div className="project__bg"
              style={{ backgroundImage: node.frontmatter.backgroundImage ? `url(${node.frontmatter.backgroundImage.publicURL})` : node.frontmatter.image ? `url(${node.frontmatter.image.publicURL})` : 'none' }}>
