...
export default function Terminal() {
  ...
  function showResume() {
    addOutput([
      ...
      "2021 - Present",
      "• Leading microservices architecture migration across legacy systems",
      "• Reduced page load times by 60% through Angular optimization and lazy loading",
      "• Building internal tooling with React and TypeScript",
      "• Mentoring junior developers on code quality and system design",
      "",
      "════════════════════════════════════════════════",
      "🛠️  SKILLS",
      "════════════════════════════════════════════════",
